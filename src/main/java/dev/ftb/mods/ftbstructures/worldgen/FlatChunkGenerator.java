...
public class FlatChunkGenerator extends ChunkGenerator {
	public static final Codec<FlatChunkGenerator> CODEC = FlatLevelGeneratorSettings.CODEC.fieldOf("settings").xmap(FlatChunkGenerator::new, FlatChunkGenerator::settings).codec();

	private final FlatLevelGeneratorSettings settings;

	public FlatChunkGenerator(FlatLevelGeneratorSettings arg) {
